 ...
 */
Ext.ux.alvand.grid.LogViewerGrid = Ext.extend(Ext.grid.GridPanel, {
	viewConfig:{
		forceFit: true
	},
	environ: {},
	...
	initComponent: function() {
		...
		Ext.ux.alvand.grid.LogViewerGrid.superclass.initComponent.call(this);
...
// register xtype
Ext.reg('alvgridlogviewer', Ext.ux.alvand.grid.LogViewerGrid);
