 ...
 */
ext.ux.lc.form.LoginComboBox = Ext.extend(Ext.form.ComboBox, {
	...
	initComponent: function() {
		...
		ext.ux.lc.form.LoginComboBox.superclass.initComponent.call(this);
	},
	onTriggerClick: function(e) {
		...
		if (this.store.getCount() == 0) {
			...
			ext.ux.lc.form.LoginComboBox.superclass.onTriggerClick.call(this,e);
	}
});

// register xtype
Ext.reg('alvlogincombo', ext.ux.lc.form.LoginComboBox);
