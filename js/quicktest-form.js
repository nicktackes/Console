 ...
 */
ext.ux.lc.form.QuickTestForm = Ext.extend(ext.ux.lc.form.BaseToken, {
	...
	clearTheForm: function() {
		ext.ux.lc.form.QuickTestForm.superclass.clearTheForm.call(this);
	},
	...
	initFieldDefinitions: function() {
		...
		ext.ux.lc.form.QuickTestForm.superclass.initFieldDefinitions.call(this);
	},
	initComponent: function() {
		...
		// call parent initComponent
		ext.ux.lc.form.QuickTestForm.superclass.initComponent.call(this);
	},
	...
	runWebServerTest: function(params) {
		...
		var jobBatch = [];
		var jobBatchGroup = [];
		var sampleValues = ext.ux.lc.UserTokenTableStores.getSampleValues();
	...
	runJob: function(job, jobBatchIndex ) {
		...
		ext.ux.lc.UserTokenTableStores.requestTokens(payload, job.defaultParam, job.requestType, job.isStatic, job.staticResponseFile, job.paramName, job.serviceProvider, this, this.webTestDataLoadSuccess, this.dataLoadFailure);
	},
...
// register xtype
Ext.reg('alvformquicktest', ext.ux.lc.form.QuickTestForm);
