...
/**
 * ext.ux.lc.LogViewer Extension Class for Ext 3.3 Library.  a polling style log viewer
 *
 * @author  Nick Tackes
 *
 * @class ext.ux.lc.LogViewer
 * @extends Ext.Panel
 */
ext.ux.lc.LogViewer = Ext.extend(Ext.Panel, {
	...
	initComponent : function() {
		...
		ext.ux.lc.LogViewer.superclass.initComponent.call(this);
...
// register xtype
Ext.reg('alvlogviewer', ext.ux.lc.LogViewer);