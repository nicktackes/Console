// create namespace
Ext.namespace('ext.ux.lc.tree');


/**
 * ext.ux.lc.HelpPanel Extension Class for Ext 3.3 Library
 *
 * @author  Nick Tackes
 *
 * @class ext.ux.lc.HelpPanel
 * @extends Ext.Panel
 */
ext.ux.lc.HelpPanel = Ext.extend(Ext.Panel, {
   // title: 'Help',
    layout: 'border',
    region: 'east',
    split: true,
    ...
    initComponent: function(){
        ...
        ext.ux.lc.HelpPanel.superclass.initComponent.call(this);
        
    }
});

// register xtype
Ext.reg('alvhelp', ext.ux.lc.HelpPanel);
