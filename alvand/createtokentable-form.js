...
/**
 * Ext.ux.alvand.form.CreateTokenTable Extension Class for Ext 3.3 Library
 *
 * @author  Nick Tackes
 *
 * @class Ext.ux.alvand.form.CreateTokenTable
 * @extends Ext.form.FormPanel
 */
Ext.ux.alvand.form.CreateTokenTable = Ext.extend(Ext.ux.alvand.form.BaseToken, {
	...
	initFieldDefinitions: function() {
		...
		Ext.ux.alvand.form.CreateTokenTable.superclass.initFieldDefinitions.call(this);
...
// register xtype
Ext.reg('alvformcreatetokentable', Ext.ux.alvand.form.CreateTokenTable);
