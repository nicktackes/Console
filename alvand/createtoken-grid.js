...
/**
 * Ext.ux.alvand.grid.CreateToken Extension Class for Ext 3.3 Library
 *
 * @author  Nick Tackes
 *
 * @class Ext.ux.alvand.grid.CreateToken
 * @extends Ext.grid.EditorGridPanel
 */
Ext.ux.alvand.grid.CreateToken = Ext.extend(Ext.grid.EditorGridPanel, {
    ...
    initComponent: function(){
        ...
        Ext.ux.alvand.grid.CreateToken.superclass.initComponent.call(this);
        
    }
});

// register xtype
Ext.reg('alvgridcreatetoken', Ext.ux.alvand.grid.CreateToken);
