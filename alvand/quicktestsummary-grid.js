...
/**
 * Ext.ux.alvand.grid.DBLogin Extension Class for Ext 3.3 Library
 *
 * @author  Nick Tackes
 *
 * @class Ext.ux.alvand.grid.QuickTestSummaryGrid
 * @extends Ext.grid.GridPanel
 */
Ext.ux.alvand.grid.QuickTestSummaryGrid = Ext.extend(Ext.grid.GridPanel, {
	...
	showResultWindow: function(record, testType, title) {
		...
		if(!this.resWins[id + testType]) {
			this.resWins[id + testType] = new Ext.ux.alvand.QuickTestResultWindow({
	...
	initComponent: function() {
		...
		Ext.ux.alvand.grid.QuickTestSummaryGrid.superclass.initComponent.call(this);

	}
});

// register xtype
Ext.reg('alvgridquicktestsummary', Ext.ux.alvand.grid.QuickTestSummaryGrid);
