 ...
 * @author  Nick Tackes
 *
 * @class Ext.ux.alvand.grid.DBLogin
 * @extends Ext.grid.EditorGridPanel
 */
Ext.ux.alvand.grid.DBLogin = Ext.extend(Ext.grid.EditorGridPanel, {
		...
		Ext.Ajax.request({
			...
			success: function(response, request) {
				...
				if(success) {
					...
					Ext.ux.alvand.UserTokenTableStores.register(record.get('username'), record.get('password'));
	...
	initComponent: function() {
		...
		Ext.ux.alvand.grid.DBLogin.superclass.initComponent.call(this);

	}
});

// register xtype
Ext.reg('alvgriddblogin', Ext.ux.alvand.grid.DBLogin);
