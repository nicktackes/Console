...
/**
 * Ext.ux.alvand.grid.ResultToken Extension Class for Ext 3.3 Library
 *
 * @author  Nick Tackes
 * @version $Id: Ext.ux.alvand.grid.ResultToken.js
 *
 * @class Ext.ux.alvand.grid.ResultToken
 * @extends Ext.grid.GridPanel
 */
Ext.ux.alvand.grid.ResultToken = Ext.extend(Ext.grid.GridPanel, {
	viewConfig: {
		templates: {
	...
	initComponent: function() {
		...
		Ext.ux.alvand.grid.ResultToken.superclass.initComponent.call(this);
	...
	requestTokens: function(payload, defaultParam, requestType, isStatic, staticResponseFile, paramName, serviceProvider) {
		...
		Ext.ux.alvand.UserTokenTableStores.requestTokens(payload, defaultParam, requestType, isStatic, staticResponseFile, paramName, serviceProvider, this, this.dataLoadSuccess);
	},
...
// register xtype
Ext.reg('alvgridresultstoken', Ext.ux.alvand.grid.ResultToken);
